...
#define DELTA
  ...
  #define DELTA_HEIGHT 126.0             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 57.14, 57.14, 57.14, 48.5 }
...
#define HOMING_FEEDRATE_Z  (100*30)
